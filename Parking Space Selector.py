...
def draw_text(image, text, position, font_scale=1, thickness=2, color=(255, 255, 255)):
...
while True:
    ...
    draw_text(image, 'Left click to add, Right click to remove', (10, 60), font_scale=1, thickness=2, color=(0, 255, 0), shadow_color=(0, 0, 0))
